write-host "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
write-host -ForegroundColor Cyan "PowerShell Version"
...
$modelText = "C:\ComputerInfoReport\$($NameHere).txt:4:CsModel         : "
$serialText = "C:\ComputerInfoReport\$($NameHere).txt:6:BiosSeralNumber : "
$hostText = "C:\ComputerInfoReport\$($NameHere).txt:5:CsUserName      : SCPC\"
